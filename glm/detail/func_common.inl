...
namespace glm
{
	namespace detail
	{
		...
		struct compute_abs_vector
		{
			...
			{
				return functor1<vec, L, T, T, Q>::call(abs, x);
			}
		};
		...
		struct compute_sign
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x)
			{
				return vec<L, T, Q>(glm::lessThan(vec<L, T, Q>(0), x)) - vec<
					L, T, Q>(glm::lessThan(x, vec<L, T, Q>(0)));
			}
		};
		...
		struct compute_sign<L, T, Q, false, Aligned>
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x)
			{
				...
				vec<L, T, Q> const y(
					vec<L, typename make_unsigned<T>::type, Q>(-x) >> typename make_unsigned<T>::type(Shift));
		...
		struct compute_floor
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x)
			{
				return functor1<vec, L, T, T, Q>::call(std::floor, x);
			}
		};
		...
		struct compute_ceil
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x)
			{
				return functor1<vec, L, T, T, Q>::call(std::ceil, x);
			}
		};
		...
		struct compute_trunc
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x)
			{
				return functor1<vec, L, T, T, Q>::call(trunc, x);
			}
		};
		...
		struct compute_round
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x)
			{
				return functor1<vec, L, T, T, Q>::call(round, x);
			}
		};
		...
		struct compute_min_vector
		{
			...
			{
				return functor2<vec, L, T, Q>::call(min, x, y);
			}
		};
		...
		struct compute_max_vector
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& x, vec<L, T, Q> const& y)
			{
				return functor2<vec, L, T, Q>::call(max, x, y);
			}
		};
		...
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& edge0,
	...
	{
		GLM_STATIC_ASSERT(
			std::numeric_limits<genFIType>::is_iec559 || (std::numeric_limits<genFIType>::is_signed && std::
				numeric_limits<genFIType>::is_integer),
			"'sign' only accept signed inputs");

		return detail::compute_sign<1, genFIType, defaultp, std::numeric_limits<genFIType>::is_iec559,
									detail::is_aligned<highp>::value>::call(vec<1, genFIType>(x)).x;
	}
	...
	{
		GLM_STATIC_ASSERT(
			std::numeric_limits<T>::is_iec559 || (std::numeric_limits<T>::is_signed && std::numeric_limits<T>::
				is_integer),
			"'sign' only accept signed inputs");
	...
	*/
	...
	GLM_FUNC_QUALIFIER genType roundEven(genType x)
	{
		...
		if (FractionalPart > static_cast<genType>(0.5) || FractionalPart < static_cast<genType>(0.5)) return round(x);
		if ((Integer % 2) == 0) return IntegerPart;
	...
	// fract
	template <typename genType>
	GLM_FUNC_QUALIFIER genType fract(genType x) { return fract(vec<1, genType>(x)).x; }
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, T, Q> clamp(vec<L, T, Q> const& x, T minVal, T maxVal)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || std::numeric_limits<T>::is_integer,
						  "'clamp' only accept floating-point or integer inputs");
		return detail::compute_clamp_vector<L, T, Q, detail::is_aligned<Q>::value>::call(
			x,
			vec<L, T, Q>(minVal),
			vec<L, T, Q>(maxVal));
	}
	...
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, T, Q> clamp(vec<L, T, Q> const& x,
														vec<L, T, Q> const& minVal,
														vec<L, T, Q> const& maxVal)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || std::numeric_limits<T>::is_integer,
	...
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<L, T, Q> smoothstep(vec<L, T, Q> const& edge0,
											   vec<L, T, Q> const& edge1,
											   vec<L, T, Q> const& x)
	{
	...
	GLM_FUNC_QUALIFIER vec<L, bool, Q> isnan(vec<L, T, Q> const& v)
	{
		...
		vec<L, bool, Q> Result;
		for (length_t l = 0; l < v.length(); ++l) Result[l] = glm::isnan(v[l]);
		return Result;
	}
	...
	GLM_FUNC_QUALIFIER vec<L, bool, Q> isinf(vec<L, T, Q> const& v)
	{
		...
		vec<L, bool, Q> Result;
		for (length_t l = 0; l < v.length(); ++l) Result[l] = glm::isinf(v[l]);
		return Result;
	}
	...
	GLM_FUNC_QUALIFIER vec<L, T, Q> frexp(vec<L, T, Q> const& v, vec<L, int, Q>& exp)
	{
		...
		vec<L, T, Q> Result;
		for (length_t l = 0; l < v.length(); ++l) Result[l] = std::frexp(v[l], &exp[l]);
		return Result;
	}
	...
	GLM_FUNC_QUALIFIER vec<L, T, Q> ldexp(vec<L, T, Q> const& v, vec<L, int, Q> const& exp)
	{
		...
		vec<L, T, Q> Result;
		for (length_t l = 0; l < v.length(); ++l) Result[l] = std::ldexp(v[l], exp[l]);
		return Result;
	}
}//namespace glm
