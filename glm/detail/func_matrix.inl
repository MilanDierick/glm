...
namespace glm
{
	namespace detail
	{
		...
		struct compute_matrixCompMult_type
		{
			GLM_FUNC_QUALIFIER static mat<C, R, T, Q> call(mat<C, R, T, Q> const& x, mat<C, R, T, Q> const& y)
			{
				GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
					...
					;
				return compute_matrixCompMult<C, R, T, Q, is_aligned<Q>::value>::call(x, y);
			}
		};
		...
		{
			GLM_FUNC_QUALIFIER static typename outerProduct_trait<DA, DB, T, Q>::type call(
				vec<DA, T, Q> const& c,
				vec<DB, T, Q> const& r)
			{
				typename outerProduct_trait<DA, DB, T, Q>::type m;
		...
		struct compute_outerProduct_type
		{
				...
				vec<DB, T, Q> const& r)
			{
				...
				return compute_outerProduct<DA, DB, T, Q>::call(c, r);
			}
		};
		...
		struct compute_transpose_type
		{
			GLM_FUNC_QUALIFIER static mat<R, C, T, Q> call(mat<C, R, T, Q> const& m)
			{
				GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
					...
					;
				return compute_transpose<C, R, T, Q, is_aligned<Q>::value>::call(m);
			}
		};
		...
		struct compute_determinant<3, 3, T, Q, Aligned>
		{
			...
			{
				return + m[0][0] * (m[1][1] * m[2][2] - m[2][1] * m[1][2]) - m[1][0] * (m[0][1] * m[2][2] - m[2][1] * m[
					0][2]) + m[2][0] * (m[0][1] * m[1][2] - m[1][1] * m[0][2]);
			}
		};
		...
		struct compute_determinant_type
		{
			GLM_FUNC_QUALIFIER static T call(mat<C, R, T, Q> const& m)
			{
				GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
					...
					;
				return compute_determinant<C, R, T, Q, is_aligned<Q>::value>::call(m);
			}
		};
		...
		struct compute_inverse<2, 2, T, Q, Aligned>
		{
			GLM_FUNC_QUALIFIER static mat<2, 2, T, Q> call(mat<2, 2, T, Q> const& m)
			{
				...
				mat<2, 2, T, Q> Inverse(+ m[1][1] * OneOverDeterminant,
		...
		struct compute_inverse<3, 3, T, Q, Aligned>
		{
			GLM_FUNC_QUALIFIER static mat<3, 3, T, Q> call(mat<3, 3, T, Q> const& m)
			{
				T OneOverDeterminant = static_cast<T>(1) / (+ m[0][0] * (m[1][1] * m[2][2] - m[2][1] * m[1][2]) - m[1][0
				] * (m[0][1] * m[2][2] - m[2][1] * m[0][2]) + m[2][0] * (m[0][1] * m[1][2] - m[1][1] * m[0][2]));
	...
	{
		return detail::compute_matrixCompMult_type<
			C, R, T, Q, std::numeric_limits<T>::is_iec559, detail::is_aligned<Q>::value>::call(x, y);
	}
	...
	{
		return detail::compute_transpose_type<C, R, T, Q, std::numeric_limits<T>::is_iec559, detail::is_aligned<Q
											  >::value>::call(m);
	}
	...
	{
		return detail::compute_determinant_type<C, R, T, Q, std::numeric_limits<T>::is_iec559, detail::is_aligned<Q
												>::value>::call(m);
	}
