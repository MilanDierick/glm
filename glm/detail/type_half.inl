	...
	namespace detail
	{
		...
		GLM_FUNC_QUALIFIER hdata toFloat16(float const& f)
		{
			...
			if (e <= 0)
			{
				...
				return static_cast<hdata>(s | (m >> 13));
			}
			if (e == 0xff - (127 - 15))
			{
				if (m == 0)
					...
					return static_cast<hdata>(s | 0x7c00);
				//
				...
				return static_cast<hdata>(s | 0x7c00 | m | (m == 0));
			}
			//
			...
			return static_cast<hdata>(s | (e << 10) | (m >> 13));
		}
	}//namespace detail
}//namespace glm
