...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR mat(T x0, T y0, T z0, T w0, T x1, T y1, T z1, T w1, T x2, T y2, T z2, T w2);
		...
		GLM_FUNC_DECL GLM_CONSTEXPR mat(X1 x1,
										Y1 y1,
										Z1 z1,
										W1 w1,
										X2 x2,
		...
		GLM_FUNC_DECL GLM_CONSTEXPR mat(vec<4, V1, Q> const& v1, vec<4, V2, Q> const& v2, vec<4, V3, Q> const& v3);
	...
	template <typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<3, 4, T, Q>::col_type operator*(mat<3, 4, T, Q> const& m,
															   typename mat<3, 4, T, Q>::row_type const& v);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<3, 4, T, Q>::row_type operator*(typename mat<3, 4, T, Q>::col_type const& v,
															   mat<3, 4, T, Q> const& m);
