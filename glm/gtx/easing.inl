...
namespace glm
{
	...
	GLM_FUNC_QUALIFIER genType quadraticEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(2) * a * a;
	...
	GLM_FUNC_QUALIFIER genType cubicEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(4) * a * a * a;
	...
	GLM_FUNC_QUALIFIER genType quarticEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(8) * a * a * a * a;
		genType const f = (a - one<genType>());
	...
	GLM_FUNC_QUALIFIER genType quinticEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(16) * a * a * a * a * a;
		genType const f = ((static_cast<genType>(2) * a) - static_cast<genType>(2));
	...
	GLM_FUNC_QUALIFIER genType circularEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(0.5) * (one<genType>() - std::sqrt(
			one<genType>() - static_cast<genType>(4) * (a * a)));
		return static_cast<genType>(0.5) * (std::sqrt(
			-((static_cast<genType>(2) * a) - static_cast<genType>(3)) * ((static_cast<genType>(2) * a) - one<genType>()
			)) + one<genType>());
	}
	...
	GLM_FUNC_QUALIFIER genType exponentialEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(0.5) * glm::pow(
	...
	GLM_FUNC_QUALIFIER genType elasticEaseIn(genType const& a)
	{
		...
		return std::sin(static_cast<genType>(13) * half_pi<genType>() * a) * glm::pow(
			static_cast<genType>(2),
			static_cast<genType>(10) * (a - one<genType>()));
	}
	...
	GLM_FUNC_QUALIFIER genType elasticEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(0.5) * std::sin(
			static_cast<genType>(13) * half_pi<genType>() * (static_cast<genType>(2) * a)) * glm::pow(
			static_cast<genType>(2),
	...
	template <typename genType>
	GLM_FUNC_QUALIFIER genType backEaseIn(genType const& a) { return backEaseIn(a, static_cast<genType>(1.70158)); }

	template <typename genType>
	GLM_FUNC_QUALIFIER genType backEaseOut(genType const& a) { return backEaseOut(a, static_cast<genType>(1.70158)); }
	...
	GLM_FUNC_QUALIFIER genType bounceEaseOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(4.0 / 11.0)) return (static_cast<genType>(121) * a * a) / static_cast<genType>(16);
		if (a < static_cast<genType>(8.0 / 11.0)) return (static_cast<genType>(363.0 / 40.0) * a * a) - (static_cast<
			genType>(99.0 / 10.0) * a) + static_cast<genType>(17.0 / 5.0);
		if (a < static_cast<genType>(9.0 / 10.0)) return (static_cast<genType>(4356.0 / 361.0) * a * a) - (static_cast<
			genType>(35442.0 / 1805.0) * a) + static_cast<genType>(16061.0 / 1805.0);
	...
	GLM_FUNC_QUALIFIER genType bounceEaseInOut(genType const& a)
	{
		...
		if (a < static_cast<genType>(0.5)) return static_cast<genType>(0.5) * (one<genType>() - bounceEaseOut(
			a * static_cast<genType>(2)));
