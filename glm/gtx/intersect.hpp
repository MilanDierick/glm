...
namespace glm
{
	...
	GLM_FUNC_DECL bool intersectRayPlane(genType const& orig,
										 genType const& dir,
	...
	GLM_FUNC_DECL bool intersectRayTriangle(vec<3, T, Q> const& orig,
											vec<3, T, Q> const& dir,
											vec<3, T, Q> const& v0,
											vec<3, T, Q> const& v1,
											vec<3, T, Q> const& v2,
	...
	GLM_FUNC_DECL bool intersectRaySphere(genType const& rayStarting,
										  ...
										  typename genType::value_type sphereRadiusSquered,
										  typename genType::value_type& intersectionDistance);
	...
	//! From GLM_GTX_intersect extension
	template <typename genType>
	GLM_FUNC_DECL bool intersectLineSphere(genType const& point0,
