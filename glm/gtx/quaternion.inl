...
namespace glm
{
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<3, T, Q> cross(vec<3, T, Q> const& v, qua<T, Q> const& q) { return inverse(q) * v; }

	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<3, T, Q> cross(qua<T, Q> const& q, vec<3, T, Q> const& v) { return q * v; }

	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER qua<T, Q> squad(qua<T, Q> const& q1,
									   qua<T, Q> const& q2,
									   qua<T, Q> const& s1,
									   qua<T, Q> const& s2,
									   T const& h)
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<3, T, Q> rotate(qua<T, Q> const& q, vec<3, T, Q> const& v) { return q * v; }

	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<4, T, Q> rotate(qua<T, Q> const& q, vec<4, T, Q> const& v) { return q * v; }
	...
	GLM_FUNC_QUALIFIER qua<T, Q> shortMix(qua<T, Q> const& x, qua<T, Q> const& y, T const& a)
	{
		...
		return qua<T, Q>(k0 * x.w + k1 * y2.w, k0 * x.x + k1 * y2.x, k0 * x.y + k1 * y2.y, k0 * x.z + k1 * y2.z);
	}
	...
	GLM_FUNC_QUALIFIER qua<T, Q> rotation(vec<3, T, Q> const& orig, vec<3, T, Q> const& dest)
	{
		...
		return qua<T, Q>(s * static_cast<T>(0.5f), rotationAxis.x * invs, rotationAxis.y * invs, rotationAxis.z * invs);
	}
}//namespace glm
